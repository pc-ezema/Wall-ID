      ...
      <div class="col-lg-6">
        <div class="login-content">
          <div class="login-form">
            ...
            <form
              class="form-form-div"
              @submit.prevent="resendConfirmationEmail()"
            >
              <!-- Email Here -->
              <div>
                <p>
                  Before proceeding, please check your email
                  <span class="spanner">{{ email }}</span> for a verification
                  link.
                </p>
                <p>
                  If you did not receive the email in 15 minutes, please check
                  your spam folder. Or,
                </p>
              </div>
...
export default {
  ...
  methods: {
    async resendConfirmationEmail() {
      this.$Progress.start();
      await axios
        .post("auth/resend/emailverification/" + this.email)
        .then((response) => {
          this.error = "";
