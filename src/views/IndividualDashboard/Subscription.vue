<template>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="dashboard_header_title">
                                        <h3>Subscription</h3>
                                        <p><router-link to="/individual-dashboard/membership-subscription"><a><i class="bi bi-arrow-left"></i> Membership & Subscription</a></router-link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="QA_table mb_30">
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody v-if="!active || !active.length">
                                            <tr>
                                                <td class="align-enter text-dark font-13" colspan="7">No Active Subscription</td>
                                            </tr>
                                        </tbody>
                                        <tbody v-else>
    ...
    >
        ...
        <div class="modal-content viewCardModal">
            ...
            <h5 class="modal-title" id="exampleModalLongTitle">View Payment Details</h5>
            <button
                type="button"
                class="close"
                data-dismiss="modal"
            ...
            <div class="modal-body">
                <div class="view_payment">
                    ...
                    <p><b>Paid At: </b> {{ new Date(payment_details.paid_at).toLocaleString() }}</p>
                    <p style="float: right;"><a class="a-approved">{{ payment_details.status }}</a></p>
                </div>
            </div>
        </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        loadActiveSubscription(page = 1) {
            axios.get('individuals/organizations/subscriptions/active/all')
            .then(
                response => {
