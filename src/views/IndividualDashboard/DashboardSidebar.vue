    ...
    <nav class="sidebar">
         ...
         <ul id="sidebar_menu">
            ...
            <li class="">
                ...
                <ul>
                   <li><router-link to="/individual-dashboard/event-management" class="menuRouter"><a>Overview</a></router-link></li>
                   <li><router-link to="/individual-dashboard/upcoming-event" class="menuRouter"><a>Upcoming Event</a></router-link></li>
                   <li><router-link to="/individual-dashboard/event-gallery" class="menuRouter"><a>Event Gallery</a></router-link></li>
                   <li><router-link to="/individual-dashboard/create-event" class="menuRouter"><a>Create Event</a></router-link></li>
                   <li><router-link to="/individual-dashboard/invitation" class="menuRouter"><a>Invitations</a></router-link></li>
                   <li><router-link to="/individual-dashboard/event-history" class="menuRouter"><a>History</a></router-link></li>
                </ul>
             </li>
            ...
            <li class="">
                ...
                <ul>
                   <li><router-link to="/individual-dashboard/membership-subscription" class="menuRouter"><a>Overview</a></router-link></li>
                   <li><router-link to="/individual-dashboard/memberships" class="menuRouter"><a>Membership</a></router-link></li>
                   <li><router-link to="/individual-dashboard/subscriptions" class="menuRouter"><a>Subscription</a></router-link></li>
