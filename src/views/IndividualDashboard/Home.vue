                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="dashboard_header_title">
                                        <h3>{{ getTime() }}, {{ user.details.firstname }} {{ user.details.lastname }}!
                                        <span style="float: right;">{{ user.details.id_card_number }}</span></h3>                                        
                                    </div>
                                </div>
                            </div>
                        </div>
                   ...
                   <div class="col-lg-6 mb-4">
                        <div class="ser-box serbox1">
                            <router-link to="/individual-dashboard/id-card-management">
                                <a>
                                    <h5>
                                        <img src="@/assets/img/dashAssets/serBox1.png" draggable="false">
                                        <span>ID Card Management</span>
                                    </h5>
                                </a>
                            </router-link>
                            <p><i class="bi bi-question-circle-fill" data-toggle="modal" data-target="#modalID"></i></p>
                        </div>
                   </div>
                   <!--Box 2-->
                   <div class="col-lg-6 mb-4">
                        <div class="ser-box serbox2">
                            <router-link to="/individual-dashboard/event-management">
                                <a>
                                    <h5>
                                        <img src="@/assets/img/dashAssets/serBox2.png" draggable="false">
                                        <span>Event Management</span>
                                    </h5>
                                </a>
                            </router-link>
                            <p><i class="bi bi-question-circle-fill" data-toggle="modal" data-target="#modalEvent"></i></p>
                        </div>
                    </div>
                    <!--Box 3-->
                    <div class="col-lg-6 mb-4">
                        <div class="ser-box serbox3">
                            <router-link to="/individual-dashboard/membership-subscription">
                                <a>
                                    <h5>
                                        <img src="@/assets/img/dashAssets/serBox3.png" draggable="false">
          ...
          <div class="modal fade" id="modalID" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content serboxModal">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">ID Card Management</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <p>Create custom ID cards for your organisation, groups or individual use.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="modalEvent" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content serboxModal">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Event Management</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <p>Create and manage your events, sell tickets and invite people to your event</p>
                        </div>
                    </div>
                </div>
            </div>
            <!--Box 3-->
            <div class="modal fade" id="modalMember" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content serboxModal">
                        <div class="modal-header">
