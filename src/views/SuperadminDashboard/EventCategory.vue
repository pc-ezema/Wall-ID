        ...
        <div class="row justify-content-center mt-3 secForm">
          ...
          <div class="col-lg-11 filterSelect">
            <button
              ...
              data-toggle="modal"
              data-target="#modalEventCategory"
            >
              Create
            </button>
          </div>
                ...
                <div class="QA_section">
                  <div class="QA_table mb_30">
                    <table class="table lms_table_active">
                      ...
                      <tbody>
                        <tr
                          v-for="(row, index) in eventCategories"
                          v-bind:key="index"
                        >
                          ...
                          <td>
                            <div class="action_btns d-flex">
                              <a
                                ...
                                data-toggle="modal"
                                data-target="#modalEventEditCategory"
                                title="View"
                                class="action_btn"
                                @click="sendInfo(row)"
                              >
          ...
          <form @submit.prevent="updateEventCategory()">
            <div class="row">
              ...
              <div class="col-lg-12">
                <textarea
                  cols="30"
                  v-model="selectedEventCategory.description"
                  rows="5"
                  class="input"
                  placeholder="Description"
                ></textarea>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content viewCardModal">
        ...
        <div class="modal-footer eventCategoryForm">
          ...
          <form
            @submit.prevent="deleteEventCategory(this.selectedEventCategory.id)"
          >
            <button
              type="submit"
...
export default {
  ...
  methods: {
    ...
    getResults(page = 1) {
      axios
        .get("admin/events/category/all?page=" + page, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
        })
    ...
    async updateEventCategory() {
      ...
      await axios
        .put(
          "admin/events/category/update/" + this.selectedEventCategory.id,
          {
    ...
    async deleteEventCategory(data) {
      this.$Progress.start();
      await axios
        .delete("admin/events/category/destroy/" + data, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
        })
