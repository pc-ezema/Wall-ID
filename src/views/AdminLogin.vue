        ...
        <div class="row justify-content-center p-5">
            <div class="col-xl-5">
                <div class="login-content text-center">
                    <img src="@/assets/images/logo.png" width="170px" alt="Wall-ID Logo">
                    ...
                    <form class="form-form-div"  @submit.prevent="init_login()">
                        ...
                        <div>
                            ...
                            <input type="email" required placeholder="Enter your email" v-model="login.email">
                        </div>

                        <!-- Password Here -->
                        <div>
                            <label for="password">Password</label>
                            <input type="password" required placeholder="*************" v-model="login.password">
                        </div>
...
export default {
    ...
    methods: {
        async init_login() {
            ...
            await axios.post('auth/admin/login_admin', { 
