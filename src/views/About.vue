      ...
      <div class="row">
        <div class="col-lg-7 order-2 order-lg-1">
          ...
          <p>
            ...
            tempor didunt laboris nisi ut aliquip ex commodo consequat. duis
            aute irure dolor in reprehenderivoluptate velit esse cillum dolore
            fugiat nulla pariatur.Excepteur sint ocaecat cupidatat noproident
            sunt culpa qui officia deserunt mollit anim id est laborum.
          </p>
          <p>
            Sed perspiciatis unde omnisiste natus error sit voluptatem
            accusantium.doloremque ladantium totam rem aperieaque ipsa quae ab
        ...
        <div class="col-lg-5 align-self-center order-1 order-lg-2 mb-md-50">
          <img
            ...
            src="@/assets/images/welcome-phone.webp"
            alt="about img"
          />
        </div>
      </div>
