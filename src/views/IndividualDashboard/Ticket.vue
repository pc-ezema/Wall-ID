                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="dashboard_header_title">
                                        <h3>My Tickets</h3>
                                        <p><router-link to="/individual-dashboard/my-wallet"><a><i class="bi bi-arrow-left"></i> My Wallet</a></router-link></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table lms_table_active">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Download<br>Ticket</th>
